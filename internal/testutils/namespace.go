...
func CreateNamespace(ctx context.Context, k8sClient client.Client, name string, labels, annotations map[string]string) *corev1.Namespace {
...
func CreateTestNamespace(ctx context.Context, k8sClient client.Client, name string, labels map[string]string) *corev1.Namespace {
...
func EnsureNamespaceExists(ctx context.Context, k8sClient client.Client, name string, labels, annotations map[string]string) *corev1.Namespace {
	ns := factory.NewNamespace(name, labels, annotations)
