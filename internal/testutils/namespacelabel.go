...
func CreateSimpleNamespaceLabel(ctx context.Context, k8sClient client.Client, name, namespace string, labels map[string]string) *labelsv1alpha1.NamespaceLabel {
	cr := factory.NewNamespaceLabel(name, namespace, labels)
	Expect(k8sClient.Create(ctx, cr)).To(Succeed())
	return cr
}

func CreateNamespaceLabelWithObjectMeta(ctx context.Context, k8sClient client.Client, name, namespace string, objectLabels map[string]string, finalizers []string, specLabels map[string]string) *labelsv1alpha1.NamespaceLabel {
...
func GetNamespaceLabelStatus(ctx context.Context, k8sClient client.Client, name, namespace string) *labelsv1alpha1.NamespaceLabelStatus {
...
func UpdateNamespaceLabelStatus(ctx context.Context, k8sClient client.Client, name, namespace string, appliedLabels map[string]string) {
	var cr labelsv1alpha1.NamespaceLabel
