...
func (in *NamespaceLabelSpec) DeepCopyInto(out *NamespaceLabelSpec) {
	*out = *in
	...
	if in.ProtectedLabelPatterns != nil {
		in, out := &in.ProtectedLabelPatterns, &out.ProtectedLabelPatterns
...
func (in *NamespaceLabelStatus) DeepCopyInto(out *NamespaceLabelStatus) {
	*out = *in
	...
	if in.ProtectedLabelsSkipped != nil {
		in, out := &in.ProtectedLabelsSkipped, &out.ProtectedLabelsSkipped
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
